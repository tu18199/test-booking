...
final class Acl
{
    ...
    const PERMISSION_VIEW_MENU_LUU_TRU = 'view menu luu_tru';
    const PERMISSION_VIEW_MENU_TRUY_NA = 'view menu truy_na';
    const PERMISSION_VIEW_MENU_HISTORY = 'view menu history';
    ...
    const PERMISSION_EDIT_DATA = 'manage edit_data';
    const PERMISSION_DELETE_DATA = 'manage delete_data';
    const PERMISSION_USER_MANAGE = 'manage user';
    const PERMISSION_CONFIG_MANAGE = 'manage config';
